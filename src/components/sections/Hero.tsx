...
export function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden -mt-12">
            {/* Ambient Glow */}
            <div className="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-white/[0.03] blur-[120px] rounded-full pointer-events-none" />
            ...
            <motion.div
                ...
                className="mt-8 flex flex-wrap items-center justify-center gap-x-5 gap-y-4 px-4"
            >
                ...
                <a href={profile.links.discord} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-white transition-colors duration-300" title="@devworld">
                    <DiscordIcon />
                </a>
            ...
            >
                <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium bg-bg-surface border border-border-subtle rounded-full text-text-primary hover:border-white/20 hover:text-white transition-all"
                >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    </svg>
                    <span>{t({ en: "View CV", ko: "이력서 (CV)" })}</span>
                </a>
            </motion.div>

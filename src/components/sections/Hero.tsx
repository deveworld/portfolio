    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden -mt-12">
            ...
            >
                ...
                <a href={profile.links.huggingface} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-white transition-colors duration-300 grayscale hover:grayscale-0 opacity-80 hover:opacity-100" title="Hugging Face">
                    <HuggingFaceIcon />
                </a>
